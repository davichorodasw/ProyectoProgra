...
<main class="main-content">
        ...
        <form method="GET" action="" class="filters-form">
            <div class="filters">
                ...
                <div class="filter-group">
                    ...
                    <a href="cds.php" style="margin-left: 10px; color: #e74c3c; text-decoration: underline;">Limpiar</a>
                </div>
            </div>
        </form>
    </section>
    ...
    <section class="products-section">
        <div class="products-grid">
            ...
            $sql = "SELECT * FROM productos WHERE tipo = 'cd'";
            $conditions = [];
            ...
            <?php else: ?>
                <p style="text-align:center; grid-column: 1 / -1; font-size:1.2em; color:#666;">
                    ...
                    <br><a href="cds.php" style="color:#e74c3c;">Ver todos</a>
                </p>
            <?php endif; ?>
